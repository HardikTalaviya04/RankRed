    ...
    <footer className="border-t bg-muted/20 py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
        <div className="col-span-1 md:col-span-1 flex flex-col gap-4">
          <Link href="/" className="font-bold text-xl">ReddGrow</Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link href="https://chromewebstore.google.com/detail/reddgrow-your-growth-assi/hgpbemhkofmchpkjckocgdfpjiijhpkd" className="hover:text-foreground">Chrome Extension</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link href="https://docs.reddgrow.ai" className="hover:text-foreground">Docs</Link></li>
      ...
      <div className="container mx-auto mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
        <p>&copy; 2026 ReddGrow. All rights reserved.</p>
        <div className="flex gap-4">
