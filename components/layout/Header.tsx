      ...
      <div className="container flex h-14 items-center justify-between px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center space-x-2">
            <span className="font-bold text-xl">ReddGrow</span>
          </Link>
        ...
        <div className="flex items-center gap-4">
          <Link href="https://chromewebstore.google.com/detail/reddgrow-your-growth-assi/hgpbemhkofmchpkjckocgdfpjiijhpkd" className="hidden md:block text-sm font-medium text-foreground/60 hover:text-foreground/80">
            Chrome Extension
          </Link>
          <Link href="https://app.reddgrow.ai/login" className="text-sm font-medium text-foreground/60 hover:text-foreground/80">
            Login
          </Link>
          <Button asChild>
            <Link href="https://app.reddgrow.ai/register">Start My Free Trial</Link>
          </Button>
        </div>
      </div>
    </header>
